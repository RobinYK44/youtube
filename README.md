...
| `/letop aan minuten` | Blijft elke 3 minuten letten op **nieuwe** clips van je streamers (van de laatste 30 min) en stuurt ze meteen, met **🚀 Nu online**. `aan:False` zet het uit |
